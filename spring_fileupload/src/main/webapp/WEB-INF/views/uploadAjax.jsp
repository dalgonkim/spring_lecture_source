	...
	$.ajax({
		...
		success:function(data){
			...
			if(checkImageType(data)){
				/* 썸네일 */
				str="<div><a class='thumnail' href='"+getImageLink(data)+"'>"
				   +"<img src='displayFile?fileName="+data+"'/>"
				   +"</a><small data-src='"+data+"'><button>X</button></small></div>";
			}else{
				/* 텍스트  */
				str="<div><a class='thumnail' href='"+data+"'>"
...
$('.uploadedList').on('click','.thumnail',function(e){
	e.preventDefault();
	
	var form =$('<form>').attr({action:"displayFile",method:"post"});

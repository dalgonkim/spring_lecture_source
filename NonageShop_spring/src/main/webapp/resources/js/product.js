function go_cart() {
	if (document.formm.quantity.value == "") {
		...
		document.formm.action = "/cart/cartInsert.do";
...
function go_cart_delete() {
	...
	if (count == 0) {
		...
		document.formm.action = "/cart/cartDelete.do";
		document.formm.submit();
	}
}
...
function go_order_insert() {
	...
	if (count == 0) {
		...
		document.formm.action = "/order/orderInsert.do";
		document.formm.submit();
	}	
}
...
function go_order_delete() {
	...
	if (count == 0) {
		...
		document.formm.action = "/order/orderDelete.do";
		document.formm.submit();
	}
}

function go_direct_order() {	
	document.formm.action = "/order/orderDirectInsert.do";
	document.formm.submit();
}
...
{
	var theForm = document.frm;
	theForm.action = "/product/productList.do";
	theForm.submit();
}
//projectList.jsp
function go_search() {
...
function go_detail(tpage, pseq) {
	...
	theForm.action =  "/product/productDetail.do?tpage=" +
	                  tpage+"&pseq="+pseq;
...
function go_wrt() {
	var theForm = document.frm;
	theForm.action = "/product/productWriteForm.do";
	theForm.submit();
}
// **************** productDetail.jsp
function go_list(tpage) {
	...
	theForm.action = "/product/productList.do?tpage=" + tpage;
	theForm.submit();
}
// **************** productDetail.jsp
function go_mod(tpage, pseq) {
	...
	theForm.action = "/product/productUpdateForm.do?tpage=" + 
		              tpage+"&pseq="+pseq;
	theForm.submit();
}
...
function go_mod_mov(tpage, pseq) {
	var theForm = document.frm;
	theForm.action = '/product/productDetail.do?tpage=' + tpage + "&pseq=" + pseq;
	theForm.submit();
}

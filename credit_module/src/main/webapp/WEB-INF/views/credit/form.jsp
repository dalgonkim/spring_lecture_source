...
<table width="560" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="50" align="right" background="http://kspay.ksnet.to/store/KSPayFlashV1.3/mall/imgs/bg_top.gif" class="txt_pd1">KSNET WebHost Sample [JSP]</td>
  </tr>
  <tr>
...
<table border='0' cellpadding='0' cellspacing='0' width='500' align='center'>
    ...
    <tr>
        <td height="40" style="padding:0px 0px 0px 15px; ">
			<img src="http://kspay.ksnet.to/store/KSPayFlashV1.3/mall/imgs/ico_tit3.gif" width="30" height="30" align="absmiddle"> <strong>고객에게 보여지지 않아야 하는 설정값 항목<strong></td>
    </tr>
    <tr>

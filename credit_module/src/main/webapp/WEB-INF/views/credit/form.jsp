					...
					<table width="560" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="505" align="center">
								<table border='0' cellpadding='0' cellspacing='0' width='500'
									...
									<tr>
										<td height="40" style="padding: 0px 0px 0px 15px;"><img
											...
											width="30" height="30" align="absmiddle"> <strong>고객에게
												보여지지 않아야 하는 설정값 항목<strong></td>
									</tr>
									<tr>
										<td align="center"><table width="400" border="0"
												...
												<tr>
													<td width="110"><img
														src="http://kspay.ksnet.to/store/KSPayFlashV1.3/mall/imgs/ico_right.gif"
														width="11" height="11" align="absmiddle" readonly> 가맹점번호</td>
													<!-- 테스트용 아이디: 2999199999 (테스트이후 실제발급아이디로 변경)-->
													<td width="290"><input type='text' name='sndStoreid'
												...
												<tr>
													<td width="110"><img
														src="http://kspay.ksnet.to/store/KSPayFlashV1.3/mall/imgs/ico_right.gif"
														width="11" height="11" align="absmiddle"> 등록번호</td>
								...
								</table> <input type=hidden name=sndServicePeriod
